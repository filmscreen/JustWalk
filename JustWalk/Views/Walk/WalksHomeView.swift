        ...
        ScrollView(showsIndicators: false) {
            VStack(spacing: JW.Spacing.md) {
                ...
                WalkTypeRow(
                    ...
                    title: "Intervals",
                    subtitle: "Quick (18 min) or Standard (30 min)",
                    status: intervalStatus,
                    isAvailable: !intervalsExhausted || subscriptionManager.isPro,
                ...
                WalkTypeRow(
                    ...
                    title: "Fat Burn Zone",
                    subtitle: "Requires Apple Watch",
                    status: fatBurnStatus,
                    isAvailable: !fatBurnExhausted || subscriptionManager.isPro,
